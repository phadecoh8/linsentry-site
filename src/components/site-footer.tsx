  ...
  return (
    <div>
      ...
      <p className="mt-3 max-w-xs text-sm leading-6 text-zinc-600 dark:text-zinc-400">
        A lightweight security hardening auditor—available for Linux today, with macOS and Windows planned.
      </p>
    </div>
  )
}
...
function renderRightSide() {
  return (
    <div className="text-sm text-zinc-500 dark:text-zinc-400 sm:text-right">
      <a
        className="inline-flex items-center gap-2 hover:text-zinc-950 dark:hover:text-white"
      ...
      <p className="mt-3">
        Built by phadecoh8 · © {new Date().getFullYear()} LinSentry
      </p>
    </div>
  )
}
